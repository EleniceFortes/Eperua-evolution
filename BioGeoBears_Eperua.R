...
#checking names tree and data frame
library(ape)
library(phangorn)
library(phytools)
library(geiger)

tree<- read.tree(file="Beast_concat_30exons_25tips_renamed_MCCtreeII.nwk")
plot(tree)
areas<-read.delim2(file="eperua_biogeobears_data.txt", header = TRUE, sep = "\t", row.names=1)
name.check(areas,tree)
areas
tree

#######################################################
# SETUP: installation of all packages needed
#######################################################
...
#if all works well, the package will load no problem
library(BioGeoBEARS)
...
trfn = np("Beast_concat_30exons_25tips_renamed_MCCtreeII.nwk")
...
geogfn = np("eperua_biogeobears_data.txt")
...
numstates_from_numareas(numareas=13, maxareas=3, include_null_range=TRUE)
#numstates_from_numareas(numareas=9, maxareas=4, include_null_range=FALSE)
#numstates_from_numareas(numareas=4, maxareas=3, include_null_range=TRUE)
#numstates_from_numareas(numareas=4, maxareas=2, include_null_range=TRUE)
#numstates_from_numareas(numareas=8, maxareas=6, include_null_range=TRUE)
...
BioGeoBEARS_run_object$min_branchlength = 0.00000001    # Min to treat tip as a direct ancestor (no speciation event)
...
BioGeoBEARS_run_object$num_cores_to_use = 11
...
runslow = TRUE #TRUE or false
resfn = "Eperua_DEC.Rdata"
if (runslow)
{
...
#######################################################
#may need to rerun this block of code twice if a lot isn't made right the firs time.
pdf(file="DEC_Eperua.pdf", 10,10)
analysis_titletxt ="BioGeoBEARS DEC on Eperua"

# Setup
results_object = resDEC
scriptdir = np(system.file("extdata/a_scripts", package="BioGeoBEARS"))

# plot with States and pie charts
...
####save tiff
tiff(file="DEC_Eperua.tiff", width = 10, height = 10, units = 'in', res = 600)
analysis_titletxt ="BioGeoBEARS DEC on Eperua"
results_object = resDEC
scriptdir = np(system.file("extdata/a_scripts", package="BioGeoBEARS"))
res2 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=0.45, tipcex=0.7, statecex=0.7, splitcex=0.6, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)
...
#tiff pie chart
tiff(file="DEC_Eperua_pie.tiff", width = 10, height = 10, units = 'in', res = 600)
analysis_titletxt ="BioGeoBEARS DEC on Eperua"
results_object = resDEC
scriptdir = np(system.file("extdata/a_scripts", package="BioGeoBEARS"))
plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="pie", label.offset=0.45, tipcex=0.7, statecex=0.7, splitcex=0.6, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)
...
pdf(file="DEC+J_Eperua.pdf", 10,10)
analysis_titletxt ="BioGeoBEARS DEC+J on Eperua"
...
#######################################################
pdf("DIVAlike_Eperua.pdf", 10,10)
analysis_titletxt ="BioGeoBEARS DIVALIKE on Eperua"
...
#######################################################
pdf("DIVAlike+J_Eperua.pdf", 10,10)
analysis_titletxt ="BioGeoBEARS DIVALIKE+J on Eperua"
...
runslow = TRUE#TRUE
resfn = "Eperua_BAYAREALIKE.Rdata"
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
  res    
...
resfn = "Eperua_BAYAREALIKE+J.Rdata"
runslow = TRUE#TRUE
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
...
#######################################################
pdf("BAYAREAlike_Eperua.pdf", 10,10)
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on Eperua"
...
#tiff save
tiff("BAYAREAlike_Eperua.tiff", width = 10, height = 10, units = 'in', res = 600)
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on Eperua"
results_object = resBAYAREALIKE
scriptdir = np(system.file("extdata/a_scripts", package="BioGeoBEARS"))
res2 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=0.45, tipcex=0.7, statecex=0.7, splitcex=0.6, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)
dev.off()
# Pie chart
tiff("BAYAREAlike_Eperua_pie.tiff", width = 10, height = 10, units = 'in', res = 600)
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on Eperua"
results_object = resBAYAREALIKE
scriptdir = np(system.file("extdata/a_scripts", package="BioGeoBEARS"))
plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="pie", label.offset=0.45, tipcex=0.7, statecex=0.7, splitcex=0.6, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)
...
#######################################################
pdf("BAYAREAlike+J_Eperua.pdf", 10,10)
analysis_titletxt ="BioGeoBEARS BAYAREALIKE+J on Eperua"
...
# close to zero is the favorite model
